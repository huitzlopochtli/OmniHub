...
export function createReadarrApi(instanceId: string) {
  return {
    ...
    addAuthor: (payload: unknown) => servicePost(instanceId, '/api/v1/author', payload, {}),
    ...
    getBooks: (authorId?: number) =>
      serviceGet(instanceId, '/api/v1/book', {
...
export const readarrApi: ReturnType<typeof createReadarrApi> = new Proxy(
  {} as unknown as ReturnType<typeof createReadarrApi>,
  {
