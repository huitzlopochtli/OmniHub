...
export function createUnraidApi(instanceId: string) {
  return {
    ...
    startContainer: (id: string) =>
      gql(instanceId, `mutation StartContainer($id: String!) { startDockerContainer(id: $id) }`, {
        id,
      }),

    stopContainer: (id: string) =>
      gql(instanceId, `mutation StopContainer($id: String!) { stopDockerContainer(id: $id) }`, {
        id,
      }),
    ...
    pauseContainer: (id: string) =>
      gql(instanceId, `mutation PauseContainer($id: String!) { pauseDockerContainer(id: $id) }`, {
        id,
      }),
...
export const unraidApi: ReturnType<typeof createUnraidApi> = new Proxy(
  {} as unknown as ReturnType<typeof createUnraidApi>,
  {
