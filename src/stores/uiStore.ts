...
export type AccentColor = 'sky' | 'blue' | 'violet' | 'emerald' | 'orange' | 'rose'
...
const DEFAULT_WIDGETS: DashboardWidget[] = [
  ...
  { id: 'sonarr-queue', type: 'sonarrQueue', x: 0, y: 1, w: 1, h: 1, visible: true },
  { id: 'radarr-queue', type: 'radarrQueue', x: 1, y: 1, w: 1, h: 1, visible: true },
