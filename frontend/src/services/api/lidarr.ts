...
export function createLidarrApi(instanceId: string) {
  return {
    ...
    getArtistById: (id: number) => serviceGet<LidarrArtist>(instanceId, `/api/v1/artist/${id}`, {}),
    ...
    getAlbums: (artistId?: number) =>
      serviceGet<LidarrAlbum[]>(instanceId, '/api/v1/album', {
        params: artistId !== undefined ? { artistId } : {},
      }),
...
export const lidarrApi: ReturnType<typeof createLidarrApi> = new Proxy(
  {} as unknown as ReturnType<typeof createLidarrApi>,
  {
